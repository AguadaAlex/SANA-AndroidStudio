...
public class utilidades {
    ...
    public static final String CAMPO_LATITUD_CENTRO="latitud";
    public static final String CAMPO_LONGITUD_CENTRO="longitud";



    public  static final String CREAR_TABLA_CENTRO="CREATE TABLE "+""+TABLA_CENTRO+"("+CAMPO_ID_CENTRO+""+" INTEGER PRIMARY KEY AUTOINCREMENT,"+CAMPO_NOMBRE_CENTRO+" TEXT,"+CAMPO_DESCRIPCION_CENTRO+" TEXT,"+CAMPO_IMAGEN_CENTRO+" BLOG,"+CAMPO_DESCRIPCION_CENTRO+" TEXT,"+CAMPO_LATITUD_CENTRO+" TEXT,"+CAMPO_LONGITUD_CENTRO+" TEXT)";
}
